...
> 상세 참조: `rules/docs-omc-ref.md` (거버넌스 정의, SRS/PRD 선택 기준, 갱신 조건, IEEE 매핑)
...
상위 문서 갱신 시 하위/연관 문서의 갱신 필요성을 사용자에게 알린다. 자동 갱신하지 않고 사용자 확인 후 진행한다. 개별 갱신 조건은 `rules/docs-omc-ref.md` 참조.
