...
log('[3/5] 훅 등록...');
ensureDir(hooksDir);
for (const hook of ['_parse-input.mjs', 'session-start.mjs', 'pre-commit-check.mjs', 'post-save-mmd.mjs', 'post-doc-toc-sync.mjs', 'post-doc-header-validate.mjs', 'pre-compact.mjs', 'post-compact.mjs', 'intent-drift-check.mjs', 'doc-update-check.mjs']) {
