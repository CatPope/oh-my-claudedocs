 ...
 * Parses npm audit JSON output and fails on critical/high vulnerabilities.
 *
 * Usage: node check-dependency-audit.mjs [npm-audit.json]
 *
 * Exit code 0 = pass, 1 = blocking vulnerabilities found
 */
